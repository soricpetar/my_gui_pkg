...
import numpy as np
#from octomap_server import OctomapServer
#from octomap_msgs.msg import BoundingBoxQuery
...
class Integrator:
    ...
    def run(self, cloud: PointCloud):
            ...
            #self.scene.add_box("box_2", box_pose_2, size=(0.1, 0.1, 0.1))
            #self.scene.add_box("box_3", box_pose_3, size=(0.1, 0.1, 0.1))

            #plt.show()
                    
            ##################### OCTOMAP
                    
            #bounding_box = BoundingBoxQuery()

            #bounding_box.pose = box_pose.pose
            #bounding_box.box_size.x = dim1
            #bounding_box.box_size.y = dim2
            #bounding_box.box_size.z = dim3

            #self.octomap_server.insertBBX(bounding_box)
    ...
    def __init__(self):
        ...
        #self.octomap_server = OctomapServer()
